...
public class gudang extends javax.swing.JPanel {
    ...
    private void getData(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Object[] rowData = {ID_Barang,Nama_Barang,Harga,Stok,Kategori};
    ...
    private void initComponents() {
        ...
        btn_generate.setBackground(new java.awt.Color(102, 102, 255));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(T_ID, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(T_code, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
        ...
        tbl_data.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Barang", "Deskripsi", "Harga", "Stok", "Kategori"
            }
        ));
    ...
    String kategori     = T_kategori.getSelectedItem().toString();
        ...
        if (id_barang.isEmpty() || deskripsi.isEmpty()  || harga.isEmpty() || stok.isEmpty() || kategori.isEmpty()){
                JOptionPane.showMessageDialog(this, "Semua kolom harus di isi","Peringatan!!", JOptionPane.ERROR_MESSAGE);
                return;
        }
        try {
            String sql = "INSERT INTO Barang(ID_Barang, Nama_Barang, Harga, Stok, Kategori, Kode_Barcode) VALUES (?, ?, ?, ?, ?, ?)";
            PreparedStatement st = c.prepareStatement(sql);
    ...
    try{
        ...
        barcode.setData(T_code.getText());
        barcode.setI(11.0f);
        
        String name = T_code.getText();
        
        barcode.renderBarcode("/home/bass/Pictures/" + name + ".png");
